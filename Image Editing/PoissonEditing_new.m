function [newImg] = PoissonEditing_new (bImg, pImg, mskR, corB, mode, version,thres)
%
...
%   MODE     Showing results (1) or debug (2)                       [Scalar]
%   VERSION       Choose Conjugate Gradient (CG)/                   [Scalar]
%                       Direct Solver (with Sparse Matrix) Method
...
switch version
    ...
    case 1
        for i=1:3
            ...
            xnew0(:,i)=pcgstab(A,b0,thres,maxIter,Iden,Iden,x01);
        end
...
% New version by Dezhi Wang, Yuan Fang, Qiwei Han
% Spring 2016
%
